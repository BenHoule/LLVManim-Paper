...
\begin{quotation} [19]---% ADDRESSED - Removed trace mapping and usability metrics from goals, combined core and major features
...
\begin{quotation} [22]---% ADDRESSED - Removed mention of Sugiyama algorithm
...
\end{quotation}
\noindent Verbosity in this context refers to the amount of information displayed in the animation, such as whether variable values are shown or only control flow is visualized. It is different from animation speed, which controls how quickly the animation plays. This is a common feature in debugging tools, and we feel it is reasonable to expect readers to understand this distinction.
