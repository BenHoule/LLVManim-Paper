...
\captionof{sourcelisting}{Full C source (\texttt{double.c}) used for all sample animations.}
\label{code:double.c}
...
\captionof{sourcelisting}{Full LLVM~IR source (\texttt{double.ll}) used for all sample animations.}
\label{code:double.ll}
