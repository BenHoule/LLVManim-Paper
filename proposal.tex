...
\section{Manim}
The Manim library was originally developed by Grant Sanderson\cite{3b1b-website} for his educational YouTube channel "3Blue1Brown", specifically for animating math and computer science concepts.\cite{3b1b-channel} His beginner-friendly animations assisted him in becoming one of the more well-known online personalities in these fields and have helped countless others improve their understanding of complex topics. This history makes it a prime candidate as a tool for creating high-quality educational/informational presentations, but many are unable or unwilling to spend the time and effort it takes to create custom animations using a third-party Python library.
